...
#include "turtle_interfaces/msg/detail/waypoint_list__rosidl_typesupport_fastrtps_c.h"
...
#include "turtle_interfaces/msg/detail/waypoint__functions.h"  // waypoints
...
size_t get_serialized_size_turtle_interfaces__msg__Waypoint(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_turtle_interfaces__msg__Waypoint(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtle_interfaces, msg, Waypoint)();


using _WaypointList__ros_msg_type = turtle_interfaces__msg__WaypointList;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: waypoints
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, turtle_interfaces, msg, Waypoint
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: waypoints
  {
    ...
    if (ros_message->waypoints.data) {
      turtle_interfaces__msg__Waypoint__Sequence__fini(&ros_message->waypoints);
    }
    if (!turtle_interfaces__msg__Waypoint__Sequence__init(&ros_message->waypoints, size)) {
...
size_t get_serialized_size_turtle_interfaces__msg__WaypointList(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _WaypointList__ros_msg_type * ros_message = static_cast<const _WaypointList__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name waypoints
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_turtle_interfaces__msg__Waypoint(
...
static uint32_t _WaypointList__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_turtle_interfaces__msg__WaypointList(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtle_interfaces
size_t max_serialized_size_turtle_interfaces__msg__WaypointList(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: waypoints
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_turtle_interfaces__msg__Waypoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = turtle_interfaces__msg__WaypointList;
    is_plain =
      (
...
static size_t _WaypointList__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_turtle_interfaces__msg__WaypointList(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtle_interfaces, msg, WaypointList)() {
