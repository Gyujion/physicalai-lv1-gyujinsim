...
#include "turtle_interfaces/msg/detail/waypoint_list__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const turtle_interfaces::msg::Waypoint &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  turtle_interfaces::msg::Waypoint &);
size_t get_serialized_size(
  const turtle_interfaces::msg::Waypoint &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const turtle_interfaces::msg::WaypointList & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  turtle_interfaces::msg::WaypointList & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: waypoints
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        turtle_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_Waypoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = turtle_interfaces::msg::WaypointList;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const turtle_interfaces::msg::WaypointList *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<turtle_interfaces::msg::WaypointList *>(
    untyped_ros_message);
...
{
  return &turtle_interfaces::msg::typesupport_fastrtps_cpp::_WaypointList__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtle_interfaces, msg, WaypointList)() {
  return &turtle_interfaces::msg::typesupport_fastrtps_cpp::_WaypointList__handle;
}
