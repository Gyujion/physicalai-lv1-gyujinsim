...
#include "turtle_interfaces/msg/detail/waypoint__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const turtle_interfaces::msg::Waypoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  turtle_interfaces::msg::Waypoint & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = turtle_interfaces::msg::Waypoint;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const turtle_interfaces::msg::Waypoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<turtle_interfaces::msg::Waypoint *>(
    untyped_ros_message);
...
{
  return &turtle_interfaces::msg::typesupport_fastrtps_cpp::_Waypoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtle_interfaces, msg, Waypoint)() {
  return &turtle_interfaces::msg::typesupport_fastrtps_cpp::_Waypoint__handle;
}
