    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'turtle_interfaces.msg.WaypointList')
            logger.debug(
            ...
            from turtle_interfaces.msg import Waypoint
...
class WaypointList(metaclass=Metaclass_WaypointList):
    ...
    _fields_and_field_types = {
        ...
        'waypoints': 'sequence<turtle_interfaces/Waypoint>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['turtle_interfaces', 'msg'], 'Waypoint')),  # noqa: E501
    )
