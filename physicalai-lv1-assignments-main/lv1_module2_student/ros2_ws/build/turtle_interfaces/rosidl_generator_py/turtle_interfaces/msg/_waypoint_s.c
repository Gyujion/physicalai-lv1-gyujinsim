...
bool turtle_interfaces__msg__waypoint__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("turtle_interfaces.msg._waypoint.Waypoint", full_classname_dest, 40) == 0);
  }
  turtle_interfaces__msg__Waypoint * ros_message = _ros_message;
  {  // x
...
PyObject * turtle_interfaces__msg__waypoint__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("turtle_interfaces.msg._waypoint");
