...
{
  new (message_memory) turtle_interfaces::msg::WaypointList(_init);
}

void WaypointList_fini_function(void * message_memory)
{
  auto typed_message = static_cast<turtle_interfaces::msg::WaypointList *>(message_memory);
  typed_message->~WaypointList();
}

size_t size_function__WaypointList__waypoints(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<turtle_interfaces::msg::Waypoint> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<turtle_interfaces::msg::Waypoint> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<turtle_interfaces::msg::Waypoint> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const turtle_interfaces::msg::Waypoint *>(
    get_const_function__WaypointList__waypoints(untyped_member, index));
  auto & value = *reinterpret_cast<turtle_interfaces::msg::Waypoint *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<turtle_interfaces::msg::Waypoint *>(
    get_function__WaypointList__waypoints(untyped_member, index));
  const auto & value = *reinterpret_cast<const turtle_interfaces::msg::Waypoint *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember WaypointList_message_member_array[2] = {
  {
    ...
    offsetof(turtle_interfaces::msg::WaypointList, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<turtle_interfaces::msg::Waypoint>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(turtle_interfaces::msg::WaypointList, waypoints),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers WaypointList_message_members = {
  ...
  2,  // number of fields
  sizeof(turtle_interfaces::msg::WaypointList),
...
get_message_type_support_handle<turtle_interfaces::msg::WaypointList>()
{
  return &::turtle_interfaces::msg::rosidl_typesupport_introspection_cpp::WaypointList_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtle_interfaces, msg, WaypointList)() {
  return &::turtle_interfaces::msg::rosidl_typesupport_introspection_cpp::WaypointList_message_type_support_handle;
}
