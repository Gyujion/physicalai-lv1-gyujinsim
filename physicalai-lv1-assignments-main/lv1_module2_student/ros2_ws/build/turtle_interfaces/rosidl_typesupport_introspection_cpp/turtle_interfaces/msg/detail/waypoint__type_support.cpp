...
{
  new (message_memory) turtle_interfaces::msg::Waypoint(_init);
}

void Waypoint_fini_function(void * message_memory)
{
  auto typed_message = static_cast<turtle_interfaces::msg::Waypoint *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Waypoint_message_member_array[4] = {
  {
    ...
    offsetof(turtle_interfaces::msg::Waypoint, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(turtle_interfaces::msg::Waypoint, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(turtle_interfaces::msg::Waypoint, tolerance),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(turtle_interfaces::msg::Waypoint, label),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Waypoint_message_members = {
  ...
  4,  // number of fields
  sizeof(turtle_interfaces::msg::Waypoint),
...
get_message_type_support_handle<turtle_interfaces::msg::Waypoint>()
{
  return &::turtle_interfaces::msg::rosidl_typesupport_introspection_cpp::Waypoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtle_interfaces, msg, Waypoint)() {
  return &::turtle_interfaces::msg::rosidl_typesupport_introspection_cpp::Waypoint_message_type_support_handle;
}
